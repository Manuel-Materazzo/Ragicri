...
INSERT INTO indirizzo(via, provincia, cap, civico) VALUES ('Via 17 Agosto', 'PD', 36044, 18);
...
INSERT INTO utente (nome, username, password, email, indirizzo, ruolo) VALUES ('Federico Violetti', 'utente', '$2a$10$sHZGHYyjUx9jlIuzbHU06ehsfu0eIct9FRxiOUS96Z5jioih1kOZK', "radu.sclifos@stud.tecnicosuperiorekennedy.it", 4, 3);
...
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Edamame', 3, "Antipasti", 2.00, 'Verdura', '../../../../assets/images/piatti/edamame.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
...
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Pane orientale fritto', 6, "Antipasti", 2.00, 'Glutine', '../../../../assets/images/piatti/paneOrientaleFritto.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Pane orientale dolce', 7, "Antipasti", 2.00, 'Glutine', '../../../../assets/images/piatti/paneOrientaleDolce.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
...
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Nigiri Salmone', 31, "Nigiri", 3.00, 'Glutine Pesce', '../../../../assets/images/piatti/nigiriSalmone.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Nigiri Gambero cotto', 32, "Nigiri", 3.50, 'Glutine Crostacei', '../../../../assets/images/piatti/nigiriGambero.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Nigiri Branzino', 33, "Nigiri", 3.00, 'Glutine Pesce', '../../../../assets/images/piatti/nigiriBranzino.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Nigiri Tonno', 34, "Nigiri", 3.00, 'Glutine Pesce', '../../../../assets/images/piatti/nigiriTonno.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Nigiri Salmone Scottato', 35, "Nigiri", 3.50, 'Glutine Pesce', '../../../../assets/images/piatti/nigiriScottato.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Nigiri Anguilla', 36, "Nigiri", 2.50, 'Glutine Pesce', '../../../../assets/images/piatti/nigiriAnguilla.jpg');
...
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Sashimi Speciale', 45, "Sashimi", 16.00, 'Pesce Crostacei Molluschi', '../../../../assets/images/piatti/sashimiSpeciale.jpg');

INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Sake maki', 51, "Hosomaki", 3.00, 'Glutine Pesce', '../../../../assets/images/piatti/hosomakiSake.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Avocado maki', 52, "Hosomaki", 3.50, 'Glutine Verdura', '../../../../assets/images/piatti/hosomakiAvocado.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Tekka maki', 53, "Hosomaki", 3.00, 'Glutine Pesce', '../../../../assets/images/piatti/hosomakiTekka.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Ebi maki', 54, "Hosomaki", 2.50, 'Glutine Crostacei', '../../../../assets/images/piatti/hosomakiEbiten.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Kappa maki', 55, "Hosomaki", 2.50, 'Glutine Verdura', '../../../../assets/images/piatti/hosomakiKappa.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Tempura maki', 56, "Hosomaki", 3.50, 'Glutine Pesce', '../../../../assets/images/piatti/hosomakiTempura.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Misto maki', 57, "Hosomaki", 3.00, 'Glutine Pesce Crostacei Verdura', '../../../../assets/images/piatti/mistoMaki.jpg');

INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Sake', 61, "Temaki", 4.00, 'Glutine Pesce', '../../../../assets/images/piatti/temakiSake.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Maguro', 62, "Temaki", 4.00, 'Glutine Pesce Uova/Derivati', '../../../../assets/images/piatti/temakiMaguro.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Ebiten', 63, "Temaki", 4.00, 'Glutine Crostacei Uova/Derivati', '../../../../assets/images/piatti/temakiEbiten.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Veggie', 64, "Temaki", 4.00, 'Glutine Uova/Derivati', '../../../../assets/images/piatti/temakiVerdura.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Spicy Sake', 65, "Temaki", 5.00, 'Glutine Pesce', '../../../../assets/images/piatti/temakiSpicySake.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Spicy Tuna', 66, "Temaki", 5.00, 'Glutine Pesce', '../../../../assets/images/piatti/temakiSpicyTuna.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Miura', 67, "Temaki", 5.00, 'Glutine Pesce', '../../../../assets/images/piatti/temakiMiura.jpg');
INSERT INTO piatto (nome, numero, tipologia, prezzo, allergeni, img)
    VALUES ('Temaki Tempura', 68, "Temaki", 5.00, 'Glutine Pesce', '../../../../assets/images/piatti/temakiTempura.jpg');
